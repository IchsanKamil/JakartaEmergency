...
export default {
  ...
  // Segment
  segmentBackgroundColor: '#FF3B30',
  segmentActiveBackgroundColor: '#fff',
  segmentTextColor: '#fff',
  segmentActiveTextColor: '#FF3B30',
  segmentBorderColor: '#fff',
  segmentBorderColorMain: '#FF3B30',
